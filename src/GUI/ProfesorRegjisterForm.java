      ...
      //  String number =".*\\d+.*";//A osht numer
        ...
        Date date = new Date(stamp.getTime());
         ...
         if (first_name_field.getText().equals("") || !first_name_field.getText().matches(letters)) {
            ...
            JOptionPane.showMessageDialog(this, "Fill the Login space :", "Error", JOptionPane.ERROR_MESSAGE);
            return true;
            ...
            JOptionPane.showMessageDialog(this,
                       "Useri eshte i vdekur apo shum i vjeter?"
                        , "Error", JOptionPane.ERROR_MESSAGE);
                return true;
        }
